  ...
  },
  {
    ...
    icon: (
      <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
        <path d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.26-1.1-.59-1.62-.93-.01 2.92.01 5.84-.02 8.75-.08 1.4-.54 2.79-1.35 3.94-1.31 1.92-3.58 3.17-5.91 3.21-2.43.03-4.85-.38-6.75-1.77-1.92-1.41-3.06-3.25-3.27-5.61-.02-1.07-.01-2.14-.02-3.21 0-2.02 1.01-3.82 2.75-4.79 1.79-1.01 4.07-1.13 6.02-.42.2-.06.4-.13.59-.2.03-1.67.01-3.34.02-5.01z" />
      </svg>
    ),
  },
  {
